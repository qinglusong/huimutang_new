<?php /* Smarty version 2.6.26, created on 2018-09-04 18:27:29
...
<head>
    ...
    <script src="https://cdn.bootcss.com/Swiper/4.3.0/http://www.3e-d.com/theme/huimutang/images/js/swiper.min.js"></script>
...
<div class="header zoom-div mobile-show">
    <div class="flex-show m-title red-border">
        <div class="m-title-img-div">
            <a class="pc-show" href="/"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/logo-red.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"></a>
            <a class="mobile-show" href="/"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/title-img-r.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"></a>
        </div>
        <div class="flex-show flex-row">
            <span><a href="tel:02158878218"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/phone_red.png" alt=""></a></span>
            <span id="J_MobileNavTrigger3"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/burger_red.png" alt=""></span>
        </div>
    </div>
</div>
<div class="container zoom-div">
    <header class="pc_header white flex-show flex-row pc-show">
        <div class="pc-show flex-show pc-logo wow fadeInLeft">
            <a href="/"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/logo-red.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"></a>
        </div>
        <div class="title-right wow fadeInRight">
            <div class=" flex-column flex-right pc-show flex-show">
                <div class="pc-logo-right"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/h_right_red.png"></div>
                <nav class="nav">
                    <ul class="flex-row">
                        <li>
