<?php /* Smarty version 2.6.26, created on 2018-09-04 18:28:01
         compiled from index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'index.html', 509, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <!--<script src="https://cdn.bootcss.com/popper.http://www.3e-d.com/theme/huimutang/images/js/1.14.3/esm/popper.min.js"></script>-->
    <!--<script src="https://cdn.bootcss.com/bootstrap/4.1.1/http://www.3e-d.com/theme/huimutang/images/js/bootstrap.min.js"></script>-->
    <script src="https://cdn.bootcss.com/Swiper/4.3.0/js/swiper.min.js"></script>
    <link href="http://www.3e-d.com/theme/huimutang/images/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="http://www.3e-d.com/theme/huimutang/images/css/style.css" rel="stylesheet">
    <link href="http://www.3e-d.com/theme/huimutang/images/css/index.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="container zoom-div">
            <div class="row">
               <div class="pull-left main-header-logo hidden-sm hidden-xs">
                    <a href="/"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/logo.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"></a>
                </div>

                <div class="pull-left main-header-logo-mobile hidden-lg hidden-md">
                    <a href="/" class="flex"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/logov.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"><img class="m-logotxt" src="http://www.3e-d.com/theme/huimutang/images/imgs/m/title-img-rw.png"></a>
                </div>
                <div class="pull-right main-header-right">
                    <div class="pull-right main-header-extra ">
                        <div class="mobile-toggle hidden-lg">
                            ...
                            <span id="J_MobileNavTrigger"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/burger.png" alt=""></span>
                        </div>
                        <div class="pull-right hidden-md hidden-sm hidden-xs">
                            <div class="hhbank"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/h_right.png"></div>
...
<div class="container zoom-div">
<div class="body-img"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/body-img.jpg"></div>
...
"></a>
                ...
                <div class="pull-left main-header-logo-mobile hidden-lg hidden-md wow fadeInLeft" data-wow-delay="3000ms">
                    <a href="/" class="flex"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/logov.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"><img class="m-logotxt" src="http://www.3e-d.com/theme/huimutang/images/imgs/m/logotxt.png"></a>
                </div>
                <div class="pull-right main-header-right">
                    <div class="pull-right main-header-extra wow fadeInRight" data-wow-delay="100ms">
                        <div class="mobile-toggle hidden-lg">
                            <span><a href="tel:02158878218"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/phone.png" alt=""></a></span>
                            <span id="J_MobileNavTrigger2"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/burger.png" alt=""></span>
                        </div>
                        <div class="pull-right hidden-md hidden-sm hidden-xs">
                            <div class="hhbank"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/h_right.png"></div>
                            <nav class="hidden-md hidden-sm hidden-xs nav">
                    ...
                    <div class="content-wrap text-center">
                        <div class="item-list clearfix">
                            ...
                            <div class="num1 wow" data-wow-delay="300ms">
                                <div class="item-list-img"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/no1.png" alt=""></div>
                            </div>
                        ...
                        <div class="news-panel clearfix">
                            <div class="absolute-r wow fadeInRight" data-wow-delay="200ms">
                                <div class="pull-left boss">
                                    <img src="http://www.3e-d.com/theme/huimutang/images/imgs/boss.png">
                                </div>
                                <div class="boss-txt">
                                    <p>慧目堂创始人</p>
                                    <p> 中国最佳杰出策划师</p>
...
.html" target='_blank' ><img width='631px' height='355px' src="<?php echo $this->_tpl_vars['item']['image']; ?>
" width="100%" alt=""></a>
                                 </div>
...
" alt=""></a>
    ...
    <div class="content bg-col-07">
        <div class="tel-div">
            <div class="tel-1">
                <div class="tel-1-s wow fadeInLeft"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/s2.png"></div>
            ...
            <div class="tel-2">
                <div class="tel-1-s wow fadeInLeft" data-wow-delay="100ms"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/s1.png"></div>
        ...
        <div class="er-div wow fadeInUp" data-wow-delay="200ms">
            <img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/ew.png">
        </div>
        <div class="input-div">
...
"><?php echo $this->_tpl_vars['item']['nav_name']; ?>
    ...
    <div id="alert-cls" class="cls-btn"><img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/close_img.png"></div>
</div>
...
<script type="text/javascript" src="http://www.3e-d.com/theme/huimutang/images/js/index.js"></script>
<script type="text/javascript" src="http://www.3e-d.com/theme/huimutang/images/js/global.js?03"></script>
