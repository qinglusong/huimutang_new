<?php /* Smarty version 2.6.26, created on 2018-09-08 21:14:42
         compiled from index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'index.html', 342, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="container zoom-div">
            <div class="row">
               <div class="pull-left main-header-logo hidden-sm hidden-xs">
                    <a href="/"><img src="http://localhost/theme/huimutang/images/imgs/logo.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"></a>
                </div>

                <div class="pull-left main-header-logo-mobile hidden-lg hidden-md">
                    <a href="/" class="flex"><img src="http://localhost/theme/huimutang/images/imgs/logov.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"><img class="m-logotxt" src="http://localhost/theme/huimutang/images/imgs/m/title-img-rw.png"></a>
                </div>
...
"></a>
                ...
                <div class="pull-left main-header-logo-mobile hidden-lg hidden-md wow fadeInLeft" data-wow-delay="3000ms">
                    <a href="/" class="flex"><img src="http://localhost/theme/huimutang/images/imgs/logov.png" alt="<?php echo $this->_tpl_vars['site']['site_name']; ?>
" title="<?php echo $this->_tpl_vars['site']['site_name']; ?>
"><img class="m-logotxt" src="http://localhost/theme/huimutang/images/imgs/m/logotxt.png"></a>
                </div>
                <div class="pull-right main-header-right">
...
" width="100%" alt=""></a>
                                 ...
                                 <div class="news-panel-focus-text">
                                    <h2 class="title"><a href=""><font><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 12, "") : smarty_modifier_truncate($_tmp, 12, "")); ?>
</font></a></h2>
                                    ...
                                    <p class="date"><?php echo $this->_tpl_vars['item']['add_date']; ?>
</p>
                                </div>
                            </div>
                        </div>
