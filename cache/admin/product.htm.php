<?php /* Smarty version 2.6.26, created on 2018-09-14 15:58:20
...
" size="114" class="inpMain" />
	...
	<dl>
       ...
       <dd>
        <input type="text" name="sort_list" value="<?php if ($this->_tpl_vars['product']['sort_list'] > 0): ?><?php echo $this->_tpl_vars['product']['sort_list']; ?>
<?php else: ?>100<?php endif; ?>" size="14" class="inpMain" />
       </dd>
      </dl>
