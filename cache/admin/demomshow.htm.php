<?php /* Smarty version 2.6.26, created on 2018-08-29 14:04:22
         compiled from demomshow.htm */ ?>
...
">
   ...
   <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
    ...
    <tr>
     <td width="350" valign="top"><form action="demomshow.php?rec=<?php if ($this->_tpl_vars['show']): ?>update<?php else: ?>insert<?php endif; ?>"<?php if ($this->_tpl_vars['show']): ?> class="formEdit"<?php endif; ?> method="post" enctype="multipart/form-data">
       <div class="formBasic">
        ...
        <dl>
         ...
         <dd>
          <select name='type_id'>
            <option value=''>选择对应案例</option>
            <?php $_from = $this->_tpl_vars['demo_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
              <option <?php if ($this->_tpl_vars['show']['type_id'] == $this->_tpl_vars['item']['id']): ?>selected='selected'<?php endif; ?>  value='<?php echo $this->_tpl_vars['item']['id']; ?>
...
<?php else: ?>50<?php endif; ?>" size="20" class="inpMain" />
        ...
        <dl>
         ...
         <a href="demomshow.php" class="btnGray"><?php echo $this->_tpl_vars['lang']['cancel']; ?>
</a>
...
" width="100" /></a></td>
        ...
        <td align="center"><a href="demomshow.php?rec=edit&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="demomshow.php?rec=del&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
