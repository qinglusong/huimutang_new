<?php /* Smarty version 2.6.26, created on 2018-09-09 11:41:16
         compiled from zixun_mshow.htm */ ?>
...
">
   ...
   <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
    ...
    <tr>
     <td width="350" valign="top"><form action="zixun_mshow.php?rec=<?php if ($this->_tpl_vars['show']): ?>update<?php else: ?>insert<?php endif; ?>"<?php if ($this->_tpl_vars['show']): ?> class="formEdit"<?php endif; ?> method="post" enctype="multipart/form-data">
       <div class="formBasic">
        <dl>
...
" size="20" class="inpMain" />
        ...
        <dl>
         <dt><?php echo $this->_tpl_vars['lang']['show_contents']; ?>
</dt>
         <dd>
          <input type="text" name="show_contents" value="<?php echo $this->_tpl_vars['show']['contents']; ?>
" size="40" class="inpMain" />
         </dd>
        </dl>
        <dl>
         <dt><?php echo $this->_tpl_vars['lang']['show_slogan']; ?>
</dt>
         <dd>
          <input type="text" name="show_slogan" value="<?php echo $this->_tpl_vars['show']['slogan']; ?>
" size="20" class="inpMain" />
         </dd>
        </dl>
        <dl>
         <dt><?php echo $this->_tpl_vars['lang']['show_style']; ?>
</dt>
         <dd>
                <label><input type="radio" name="show_style" <?php if ($this->_tpl_vars['show']['style_banner'] == 2): ?>checked<?php endif; ?> value='2'/>居左版</label>
                <label><input name="show_style" <?php if ($this->_tpl_vars['show']['style_banner'] == 1): ?>checked<?php endif; ?> type="radio" value="1"/>居中版</label>
                <label><input name="show_style" <?php if ($this->_tpl_vars['show']['style_banner'] == 3): ?>checked<?php endif; ?> type="radio" value="3"/>居右版</label>
         </dd>
        </dl>
...
" target="_blank"><img width='35' height='30' src="<?php echo $this->_tpl_vars['show']['show_img']; ?>
"></a><?php else: ?><?php endif; ?> </dd>
        </dl>
        <dl>
...
<?php else: ?>50<?php endif; ?>" size="20" class="inpMain" />
        ...
        <dl>
         ...
         <a href="zixun_mshow.php" class="btnGray"><?php echo $this->_tpl_vars['lang']['cancel']; ?>
</a>
...
" width="100" /></a></td>
        ...
        <td align="center"><a href="zixun_mshow.php?rec=edit&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="zixun_mshow.php?rec=del&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
