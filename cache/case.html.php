...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'case.html', 49, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'inc/header.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <link href="http://www.3e-d.com/theme/huimutang/images/css/case.css" rel="stylesheet">
    <div class="bg_1">
...
?>
        ...
        <div class="ul-div pc-show class-1 show">
            <ul>
			<li class="wow fadeInUp" data-wow-delay="50ms"><a <?php if ($this->_tpl_vars['cat_id'] == 0): ?>class="active"<?php endif; ?> href='case_<?php echo $this->_tpl_vars['cat_f_id']; ?>
_0_1.html'>全部案例</a></li>
...
00ms"><a <?php if ($this->_tpl_vars['item']['cat_id'] == $this->_tpl_vars['cat_id']): ?>class="active"<?php endif; ?> href='case_<?php echo $this->_tpl_vars['cat_f_id']; ?>
...
<?php endif; ?></p>
    ...
    <div class="btn-down-div pc-show wow fadeIn" id='down_data' data-page='<?php echo $this->_tpl_vars['page']; ?>
' data-cat-id='<?php echo $this->_tpl_vars['cat_id']; ?>
' data-cat-f-id='<?php echo $this->_tpl_vars['cat_f_id']; ?>
'>
        <img src="http://www.3e-d.com/theme/huimutang/images/imgs/donw_btn.png">
    </div>
...
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['foo']['iteration']++;
?>
        <li><a href='case_<?php echo $this->_tpl_vars['cat_f_id']; ?>
_<?php echo $this->_tpl_vars['item']['cat_id']; ?>
_1.html'><?php echo $this->_tpl_vars['item']['cat_name']; ?>
</a></li>
    <?php endforeach; endif; unset($_from); ?>
    ...
    <div class="close-div">
        <img src="http://www.3e-d.com/theme/huimutang/images/imgs/m/close_img.png">
    </div>
</div>
                    ...
                    if(e.code==200){
						...
						$.each(e.data.list, function (n, value) {	
							newhtml +=\'<a href="nnews.html">\'+
								...
								\'<p class="bg-4m-t1">\'+value.name+\'</p>\'+
								\'<p class="bg-4m-t2">\'+value.price+\'</p>\'+
								\'</div>\'+
								\'</a>\';
								if((n+1)%3==0){
