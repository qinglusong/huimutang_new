...
// 赋值给模板-数据
$show_mobile_list = $dou->get_show_list('zixun_mshow');//移动幻灯片
$show_pc_list = $dou->get_show_list('zixun_show');//PC幻灯片
...
$news_list = $dou->get_list('article', 'ALL', $_DISPLAY['home_article'], 'sort DESC');//和首页一样
//print_r($news_list);
...
$fuwu = $dou->get_row('fuwu', '*', "type = '2'");//type=2   项目咨询页
    if($fuwu['contents']){
